...
describe WoocommerceAPIV2::Product do
  ...
  context "when CRUD with standalone product" do
    include_context "woocommerce_api_services", version: 'v3', use_cassette: 'legacy/product'
  ...
  context "when included variations" do
    include_context "woocommerce_api_services", version: 'v3', use_cassette: 'legacy/product_with_variants'
    it_behaves_like "a woocommerce product CRUD" do
