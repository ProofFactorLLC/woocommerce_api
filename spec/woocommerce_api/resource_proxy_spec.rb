...
shared_examples 'parsable response' do
  let(:parsed_response) { WoocommerceAPIV2::ResourceProxy.parse_response(response) }
...
describe WoocommerceAPIV2::ResourceProxy do
  describe '.parse_response' do
    context 'Parsing json body' do
      ...
      it 'raises error' do
        ...
        expect{
          WoocommerceAPIV2::ResourceProxy.parse_response(response)
